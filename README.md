...
| [docs/interview](./docs/interview/README.md) | 持续更新 | 分类面试题库：大模型测试 + 软件测试必备 + 自动化测试 + 性能测试 + 安全测试 + AI 测试提效共 120 题已收录，更多分类持续规划中           |
...
- 2026-09：实战教程收录「AI 测试实战系列」全部 20 篇；面试题库收录「大模型测试」「软件测试必备」「自动化测试」「性能测试」「安全测试」「AI 测试提效」各 20 题。
